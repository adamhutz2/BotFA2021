...
const int minPWM = 3;
const int maxPWM = 180; //reduced brightness for power consumption
...
void loop() {
  ...
  if (currentMillis - distanceCooldownMillis > distanceCheckedCooldownInterval) {
    distanceFinding();//This function reads the distance sensor. "If" conditional slows it down, since using delay insideit is unavoidable.
